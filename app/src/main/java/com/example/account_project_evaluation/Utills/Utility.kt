...
import com.example.account_project_evaluation.ApiHelper.ApiClient
import com.example.account_project_evaluation.ApiHelper.ApiService
...
*/
        ...
        fun shareAppIntent(activity: Activity) {
            ...
            sendIntent.putExtra(Intent.EXTRA_TEXT, "Hey check out my app at: https://play.google.com/store/apps/details?id=" +
                    com.example.account_project_evaluation.BuildConfig.APPLICATION_ID+"\nUse my referral code: ${"getUser().refralCode"}")
